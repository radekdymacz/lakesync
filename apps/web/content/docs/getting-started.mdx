...
- [React Hooks](/docs/api/react) — `useQuery`, `useMutation`, `useSyncStatus` for React apps
- [Actions](/docs/actions) — Execute imperative operations against external systems
