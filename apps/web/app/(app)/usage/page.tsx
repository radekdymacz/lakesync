...
export default function UsagePage() {
	...
	const usageResult = useUsage(from, to);
	const billingResult = useBilling();
	const loading = usageResult.status === "loading" || billingResult.status === "loading";
	const usage = usageResult.status === "success" ? usageResult.data : null;
