...
LakeSync is a monorepo containing 10 packages and 3 apps. The core sync loop follows a **push/pull** model where clients push local deltas to a gateway and pull remote deltas back.
