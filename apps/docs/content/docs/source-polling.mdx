...
This page covers SQL-based database polling. For API-based connectors like Jira that have their own built-in pollers, see [Dynamic Connectors](/docs/connectors).
