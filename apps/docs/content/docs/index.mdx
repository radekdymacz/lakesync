...
1. **Adapters** connect to data sources — Postgres, BigQuery, S3/R2, Jira, or anything you implement the interface for
...
| **Jira Cloud** | API Connector | Issues, comments, and projects via `@lakesync/connector-jira` |
