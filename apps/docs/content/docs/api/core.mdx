...
Opt-in capability for adapters that can materialise deltas into queryable destination tables. See [Materialise Protocol](/docs/architecture#materialise-protocol) for details.
